...
import { GetAllFoldersFilters } from '@/shared/types/folder.types';
...
interface FoldersFilterProps {
    ...
    filter: GetAllFoldersFilters | null;
    onFilterChange: (filter: GetAllFoldersFilters) => void;
}

const FoldersFilter: React.FC<FoldersFilterProps> = ({ accounts, filter, onFilterChange }) => {
    const [localFilterObject, setLocalFilterObject] = useState<GetAllFoldersFilters | null>(filter || null);
    ...
    const handleApplyButtonClick = () => {
        onFilterChange?.(localFilterObject as GetAllFoldersFilters);
        setIsOpen(false);
    };
                ...
                <PopoverContent align="start" className="w-80">
                    <div className="flex w-full flex-col gap-2">
                        ...
                        <div className="flex w-full flex-col">
                            ...
                            <Select
                                value={localFilterObject?.dateRange || DATE_RANGE.ALL_TIME}
